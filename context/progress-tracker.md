...
- Feature: Project dialogs (04-project-dialogs)

## Current Goal

- 04-project-dialogs complete. Next: 05-prisma (persists project metadata and storage boundaries).
...
- 05-prisma — spec exists in `context/feature-specs/05-prisma.md` and is the next implementation target.
